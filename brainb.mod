...
NEURON {
    ...
    RANGE gfb12,gfb21,gsyn12,gsyn21
}
...
PARAMETER {
   ...
   gsyn12 = 0.005  : synapse from neuron 2 to neuron 1
    gsyn21 = 0.005  : synapse from neuron 1 to neuron 2
    gfb12 = 0.001   : feedback from muscle 2 to neuron 1
    gfb21 = 0.001   : feedback from muscle 1 to neuron 2
